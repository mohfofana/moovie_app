...
module.exports = {
  ...
  theme: {
    ...
    fontFamily: {
      nunito: ["Manrope", "-apple-system", "BlinkMacSystemFont", "SF Pro Display", "sans-serif"],
      roboto: ["Outfit", "-apple-system", "BlinkMacSystemFont", "SF Pro Display", "sans-serif"],
      robotoCondensed: ["Outfit", "-apple-system", "BlinkMacSystemFont", "SF Pro Display", "sans-serif"],
